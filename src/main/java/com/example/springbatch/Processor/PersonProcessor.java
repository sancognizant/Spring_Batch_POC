...
public class PersonProcessor implements ItemProcessor<Person, ResponseODM> {

    private final OkHttpClient httpClient = new OkHttpClient();

    @Override
    public ResponseODM process(Person person) throws Exception {
...
//        }
        ...
        // after getting response, insert data into the response_model

        ResponseODM responseODM = new ResponseODM();

        responseODM.setFirstName(person.getFirstName());
        responseODM.setAmount(person.getAmount());
        responseODM.setYearlyIncome(person.getYearlyIncome());
        responseODM.setStatus("true");
        responseODM.setStatus("The loan is approved");
